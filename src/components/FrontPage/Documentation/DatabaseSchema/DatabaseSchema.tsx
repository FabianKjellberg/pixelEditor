...
const projectColumns: TableColumn[] = [
  ...
  },
  {
    ...
    type: 'TEXT',
    constraints: 'NULLABLE',
    description: 'Key for preview image in storage',
  },
  {
    name: 'created_at',
    type: 'TEXT',
...
const layerColumns: TableColumn[] = [
  { name: 'id', type: 'TEXT', constraints: 'PRIMARY KEY', description: 'UUID identifier' },
  {
    ...
    type: 'TEXT',
    constraints: 'NULLABLE',
    description: 'Key for layer data in blob storage',
  },
  {
    name: 'project_id',
    type: 'TEXT',
  ...
  { name: 'width', type: 'INTEGER', constraints: 'NOT NULL', description: 'Layer width in pixels' },
  {
    name: 'height',
    type: 'INTEGER',
    constraints: 'NOT NULL',
  ...
  { name: 'x', type: 'INTEGER', constraints: 'NOT NULL', description: 'Layer position in pixels' },
  { name: 'y', type: 'INTEGER', constraints: 'NOT NULL', description: 'Layer position in pixels' },
...
const refreshSessionColumns: TableColumn[] = [
  ...
  },
  {
    ...
    type: 'TEXT',
    constraints: 'NOT NULL',
    description: 'Session expiry (30 days)',
  },
  {
    name: 'created_at',
    type: 'TEXT',
...
const refreshTokenColumns: TableColumn[] = [
  { name: 'id', type: 'TEXT', constraints: 'PRIMARY KEY', description: 'UUID identifier' },
  {
    name: 'refresh_session_id',
    type: 'TEXT',
    constraints: 'NOT NULL, FK -> refresh_session',
  ...
  },
  {
    ...
    type: 'TEXT',
    constraints: 'NULLABLE',
    description: 'When token was rotated/invalidated',
  },
...
const DatabaseSchema = () => {
  return (
    <DocumentationSection title="Database Schema">
      <p>
        The backend uses SQLite (via Cloudflare D1) with the following tables. Foreign keys cascade
