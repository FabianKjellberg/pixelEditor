...
const Schema = z.object({
  ...
  // Canvas config
  NEXT_PUBLIC_PIXEL_SIZE: z.coerce.number().default(25),
  NEXT_PUBLIC_CANVAS_WIDTH: z.coerce.number().default(800),
  NEXT_PUBLIC_CANVAS_HEIGHT: z.coerce.number().default(800),
...
const parsed = Schema.safeParse({
  ...
  NEXT_PUBLIC_PIXEL_SIZE: process.env.NEXT_PUBLIC_PIXEL_SIZE,
  NEXT_PUBLIC_CANVAS_WIDTH: process.env.NEXT_PUBLIC_CANVAS_WIDTH,
  NEXT_PUBLIC_CANVAS_HEIGHT: process.env.NEXT_PUBLIC_CANVAS_HEIGHT,
});
...
export const config = {
  ...
  pixelSize: env.NEXT_PUBLIC_PIXEL_SIZE,
  canvasWidth: env.NEXT_PUBLIC_CANVAS_WIDTH,
  canvasHeight: env.NEXT_PUBLIC_CANVAS_HEIGHT,
